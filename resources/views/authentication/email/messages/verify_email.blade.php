                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" style="background-color: #ffffff; padding: 20px; border-radius: 8px;">
                    ...
                    <tr>
                        <td style="padding: 20px; font-size: 16px; color: #555;">
                            ...
                            <p style="text-align: center;">
                                <a href="{{ url('verify-email', $token) }}?email={{ urlencode($email) }}" style="display: inline-block; padding: 12px 24px; font-size: 16px; color: #ffffff; background-color: #000000; text-decoration: none; border-radius: 4px; font-weight: bold;">
                                    Verify Email
                                </a>
                            </p>
                        </td>
                    ...
                    <tr>
                        <td style="font-size: 14px; color: #888; text-align: center; padding: 20px;">
                            ...
                            <p><a href="{{ url('verify-email', $token) }}?email={{ urlencode($email) }}" style="color: #4CAF50;">{{ url('verify-email', $token) }}?email={{ urlencode($email) }}</a></p>
                        </td>
                    </tr>
                </table>
            </td>
