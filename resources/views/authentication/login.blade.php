    ...
    <div class="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8">
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
            <div class="bg-white px-6 py-12 shadow sm:rounded-lg sm:px-12">
                <div class="container mx-auto my-2 space-y-2">
                    @include('authentication.alerts.success')
                    @include('authentication.alerts.fail')
                    @include('authentication.alerts.warning')
                    @include('authentication.alerts.info')
                </div>
                <form class="space-y-6" method="POST">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-sm/6">
                            <a href="/forgot-password" class="font-semibold text-cyan-600 hover:text-cyan-500">Forgot
                                password?</a>
                        </div>
                    </div>
                    <div>
                        <button type="submit"
                            class="flex w-full justify-center rounded-md bg-cyan-600 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-sm hover:bg-cyan-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-600">Log
                            in</button>
                    </div>
                </form>
                <div>
            ...
            <p class="mt-10 text-center text-sm/6 text-gray-500">
                Not a member?
                <a href="/register" class="font-semibold text-cyan-600 hover:text-cyan-500">You Can Register</a>
            </p>
        </div>
    </div>
@endsection
